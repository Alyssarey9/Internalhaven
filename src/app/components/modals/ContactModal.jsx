...
export default function ContactModal() {
  return (
    <div className="p-16">
      <h2 className="text-4xl font-bold mb-6 tracking-widest font-urbanist text-cotton">WORK WITH ME → LET’S CONNECT</h2>
      ...
      <div className="space-y-8 text-cloud-gray font-coming-soon">
        <div className="bg-gradient-to-r from-apricot/20 to-dusty-rose/20 p-8 rounded-lg border border-apricot/50">
          <h3 className="text-3xl font-bold mb-6 text-apricot font-urbanist">PAGE 1: One-on-One Life Coaching Sessions:</h3>
